...
>((props, ref) => {
  ...
  return <ArkAccordion.Item ref={ref} className={cn('border-b', className)} {...restProps} />
})
...
const AccordionContent: React.FC<AccordionItemContentProps> = ({ id, className, children }) => {
  ...
  return (
    <ArkAccordion.ItemContent
      ...
      style={style}
    >
      <div ref={contentRef} id={id} className="pt-0 pb-4">
        {children}
      </div>
    </ArkAccordion.ItemContent>
  )
